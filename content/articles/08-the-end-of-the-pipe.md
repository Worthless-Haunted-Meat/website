...
Everything in this series has been moving something toward a place I haven't described. Food out of a dumpster, into a crate, into a car at midnight, and then — where?

The answer matters more than the logistics, because the destination is the only part of this system that does any managing.

Here's what I mean. Right now, in your city, the resources are scattered and the people are scattered. Surplus food is behind two hundred separate buildings at eleven at night. The people who need it are distributed across parks, underpasses, cars, couches, and a bus route. Nothing about that arrangement can be managed by anyone, no matter how well-funded. You cannot deliver sanitation to a distribution. You cannot staff a counsellor to a scatter plot. Every outreach worker in America spends most of their shift driving, looking, and guessing — not because they're inefficient, but because there is no address.
...
That's siting information you cannot get any other way, and it's what turns concentration into consent. The neighbourhood picked the spot. They usually pick better than I would, because they know which lots are dead at midnight, who owns them, and who'd say yes to a phone call.

What emerges is almost always smaller than what an architect would draw. Not a service centre — a lit parking lot behind a church with a table, and a bathroom unlocked until one in the morning. Not a facility — a container with a water hookup at the edge of a lot somebody already owns. The programme is whatever that neighbourhood agreed to fund: sanitation, food, counselling, prayer services if they want them. I've stopped arguing about that last one. A congregation that will unlock a building at midnight is worth considerably more than my opinion about their motives.

And there's a second-order effect I didn't design and only noticed later, which I'll offer as a bonus rather than a thesis.

Once the same people are in the same place at the same hour, week after week, something starts happening that isn't on anyone's job description. The volunteer who's been there four months clocks that a regular hasn't shown in a week. The runner gets recognised by name. The pastor hears that someone's about to lose their car and knows a guy with a garage.

That's the noticing from the first piece. The thing small towns did for free, that cities stopped being able to do, that no department was ever assigned. You can't fund it directly — that produces caseloads, not relationships. But it turns out you can create the conditions for it almost by accident, as a side effect of putting food and people in the same place on a schedule. A small patch of the web, restitched, in one parking lot.
